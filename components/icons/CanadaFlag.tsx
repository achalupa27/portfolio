...
const CanadaFlag = ({ color = '#000000', width = 32, height = 15 }) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' className='rounded-sm' width={width} height={height} viewBox='0 0 9600 4800'>
